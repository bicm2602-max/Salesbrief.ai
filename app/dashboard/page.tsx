...
export default async function DashboardHomePage({ searchParams }: { searchParams: Promise<{ checkout?: string }> }) {
  ...
  console.info("[subscription-presentation-debug] Dashboard presentation input", { subscriptionId: subscription.stripeSubscriptionId, stripeCustomerId: subscription.stripeCustomerId, status: subscription.status, cancelAtPeriodEnd: subscription.cancelAtPeriodEnd, currentPeriodEnd: subscription.currentPeriodEnd, plan: subscription.plan });
